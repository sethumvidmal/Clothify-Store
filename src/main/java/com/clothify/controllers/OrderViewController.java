/**
 * Sample Skeleton for 'order-view.fxml' Controller Class
 */
...
public class OrderViewController {
    ...
    private JFXButton btnRemove; // Value injected by FXMLLoader
    ...
    @FXML // fx:id="cmboSelectItem"
    private JFXComboBox<?> cmboSelectItem; // Value injected by FXMLLoader
    ...
    @FXML // fx:id="columnQty"
    private TreeTableColumn<?, ?> columnQty; // Value injected by FXMLLoader
    ...
    private JFXTextField txtCustomerName; // Value injected by FXMLLoader

    @FXML // fx:id="txtDate"
    private JFXTextField txtDate; // Value injected by FXMLLoader
    ...
    @FXML // fx:id="txtItemCode"
    private JFXTextField txtItemCode; // Value injected by FXMLLoader
    ...
    @FXML
    void cmboSelectItemOnAction(ActionEvent event) {
